...
class RunStatusSensorDefinition(SensorDefinition):
    ...
    function will be run when a job or pipeline is at the given status.

    Args:
        name (str): The name of the sensor. Defaults to the name of the decorated function.
        pipeline_run_status (PipelineRunStatus): The status of job or pipeline execution which will be
